...
<div class="container" style="overflow: auto;">
  <div class="row justify-content-center">
    <div class="col-lg-10 text-center borde rounded bg-ligh mt-5">
      ...
      <div class="table-responsive mt-2">
        <table class="table table-border table-stripe align-center text-center text-lig bg-light">
          ...
          <tr>
            ...
            <th>Total Price</th>
            <th>Remove</th>
            <th><a href="action.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('Are you sure you want to clear all your Cart?');"><i class="fas fa-trash">&nbsp;&nbsp;</i> Clear Cart</a></th>
          </tr>
          </thead>
          <tbody class= "text-ligh">
            ...
            ?>
            <tr class= "text-ligh ">
              <td class="p-5 m-"><?=  $row['id'];?></td>
              <input type="hidden" name="" class="pid" value="<?=  $row['id'];?>">

              <td><img src="<?= $row['product_image'];?>" width="50" height="50" class="bg-light m-2"></td>
              ...
              <td><input type="number" name="" id="" class="form-control itemQty" value="<?= $row['qty'];?>" style="width: 75;"></td>
            ...
            <tr>
              <td colspan="3">
                <a href="store.php" class="btn btn success text-light bg-success"> <i class="fas fa-cart-plus"></i> Shopping More</a>
              </td>
              <td colspan="2"><b>Grand Total</b></td>
              <td><b>$<?= number_format($row['grand_price'],2); //number_format($grand_total)?></b></td>
              <td><a href="checkout.php" class="btn btn-info text-light <?= ($grand_total > 1)?"":"disabled";?>"><i class="far fa-credit-card"></i> CheckOut</a></td>
            </tr>
          </tbody>
        </table>
      </div>
