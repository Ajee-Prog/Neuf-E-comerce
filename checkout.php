    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 px-4 pb-4" id="order">
            ...
            <div class="jumbotron p-3 mb-2 text-center text-light">
                <div class= "lead text-info"><h6 class= "lead text-warning"><b>Product(s) Name  :</b> <?= $allItems;?></h6></div>
            ...
            <form action=" https://www.sandbox.PayPal.com/cgi-bin/webscr"     " https://www.paypal.com/cgi-bin/webscr" method="POST" id="placeOrder" autocomplete="off">
                ...
                <div class="form-group mb-3">
                    <textarea name="address" id="" class="form-control" cols="10" rows="3" placeholder="Enter Delivery Address" required></textarea>                    
                </div>
                <h6 class="text-center lead text-light">Payment Mode</h6>
                <div class="form-group mb-3">
                    <select name="pmode" id="" class="form-control ">
                        <option value="" selected disabled>-Select Payment Mode-</option>
                        <option value="cod" disable>Cash On Delivery</option>
                ...
                <div class="form-group">
                  ...
                  ``<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                   ...
                   <!-- PayPal -->
                    ...
                    <input type="submit" name="submit" name="pay_now" id="submit" value="Place Order" class="btn btn-danger btn-block form-control">
                </div>
